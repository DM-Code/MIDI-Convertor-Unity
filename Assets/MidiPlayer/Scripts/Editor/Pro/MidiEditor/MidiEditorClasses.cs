    ...
    public partial class MidiEditorWindow : EditorWindow
    {
        ...
        class SectionAll
        {
            ...
            public void CalculateSizeAllSections(MPTKEvent last, float QuarterWidth, float CellHeight)
            {
                ...
                long miniTick = midiFileWriter.MPTK_DeltaTicksPerQuarterNote * midiFileWriter.MPTK_SignMap[0].NumberBeatsMeasure * 4 / midiFileWriter.MPTK_SignMap[0].NumberQuarterBeat;
