...
namespace MidiPlayerTK
{
    public partial class MidiLoad
    {
        ...
        public bool calculateBeatPlayer()
        {
            ...
            try
            {
                int measure = MPTK_CurrentSignMap.MPTK_TickToMeasure(MPTK_TickPlayer);
                int beat = MPTK_CurrentSignMap.MPTK_CalculateBeat(MPTK_TickPlayer, measure);
        ...
        public bool MPTK_Load(MidiFileWriter2 mfw2)
        {
            ...
            try
            {
                ...
                {
                    MPTK_MicrosecondsPerQuarterNote = MPTKEvent.MPTK_BPM2MPQN(120);
